...
public interface ServiceFactory extends AutoCloseable {
	AccountService getAccountServiceInstance() throws SQLException;
	TransferService getTransferServiceInstance() throws SQLException;
...
class ServiceContainerImpl implements ServiceFactory {
